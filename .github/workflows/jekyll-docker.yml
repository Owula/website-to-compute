    ...
    <div class="notice-body">
      <div class="notice-card">
        ...
        <div class="notice-message">
          🔊Opay service is down🚫avoid using opay bank to make your deposit with the smart earn application you can use opay bank to withdraw your money from the smart earn application... but don't use it to make your deposit okay you can use any bank of your choice to make your deposit but not opay bank 📵 thank you for your understanding make your deposit and get your account connected for you to receive your alert immediately
        </div>
  ...
  <div id="paymentPage" class="hide">
    ...
    <div class="card">
      ...
      <div class="payment-box">
        <p><strong>account:</strong> <span class="yellow">1042406558</span>
          <i class="fas fa-copy copy-icon" onclick="copyNumber('1042406558')"></i>
        </p>
        <p><strong>Bank:</strong> <span class="yellow">VFD</span></p>
        <p><strong>Name:</strong> <span class="yellow">LIVINGSTONE SARIKIY OWULA</span></p>
...
<script>
  ...
  let settings = { 
    ...
    bank: "PALMPAY", 
    waNumber: "8147081689", 
    groupLink: "https://chat.whatsapp.com/FBFQplFNwtL2GsL3ddAa9v", 
    depositAmt: 5200,
    amounts: { 
